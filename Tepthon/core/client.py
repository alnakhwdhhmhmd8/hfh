...
ZDEV = (7157276873, 7157276873, 7157276873)
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار تيبثـون ᴊᴀᴋ ✘**\n\n "
                        link = "[ܓܢܘܒ](https://t.me/zxaax)"
