...
zed_dev = (7157276873, 7157276873, 7157276873, 7157276873, 7157276873)
zel_dev = (7157276873, 7157276873, 7157276873)
zelzal = (7157276873, 7157276873, 7157276873)
...
################# Dev ZilZal #################
    ZThon = f'<a href="t.me/CU_FG">ᯓ ᴊᴀᴋ 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗗𝗮𝘁𝗮 📟</a>'
    ZThon += f"\n<b>⋆─┄─┄─┄─┄─┄─┄─⋆</b>\n\n"
...
################# Dev ZilZal #################
    ...
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ ᴊᴀᴋ ─┄─┄─┄─⋆" 
