...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ᴊᴀᴋ - أوامـر الصيد والتشيكـر](t.me/CU_FG) 𓆪\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ᴊᴀᴋ - أنـواع اليـوزرات](t.me/CU_FG) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد تيبثـــون ᴊᴀᴋ ⎉",

                    about="This channel to hunt username by - @CU_FG ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت تيبثـــون ᴊᴀᴋ ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس تيبثـــون - @CU_FG ",
